    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: 'Upload Data', requiresPermissions: ['UPLOAD_FILES'] },
        },
        {
          path: '/jobs',
          name: 'jobs',
          component: () => import('@/pages/JobManagementPage.vue'),
          meta: { title: 'Job Management', requiresRoles: ['Admin', 'Manager'] },
        },
        {
          path: '/roles',
          name: 'roles',
